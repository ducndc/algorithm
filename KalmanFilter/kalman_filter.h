...
/** \brief Output covariance matrix setter
 ...
 void setEstimate (const arma::vec& q_est)
 {
  if (arma::size (q_est) != arma::size (q_est_))
    {
      throw std::length_error ("Incorrect dimensions of estimated atate vector");
    }
  else
    {
      q_est_ = q_est;
  ...
  */
 const arma::mat& getEstimateCovariance () const 
 {
  return P_;
 }
  ...
  */
 const arma::mat& getInnovationCovariance () const
 {
  return S_;
 }
  ...
  */
 const arma::mat& getKalmanGain () const 
 {
  return K_;
 }
  ...
  */
 const arma::vec& getOutput () const 
 {
  return y_;
 }
  ...
  */
 const arma::vec& getPrediction () const
 {
  return q_pred_;
 }
  ...
  */
 const arma::vec& getEstimate () const 
 {
  return q_est_;
 }
